...
template<> bool handle_input<player0> (const map &board, bool &running, position &first, byte &ammount, direction &row_direction);//template compiler args
template<> bool handle_input<player1> (const map &board, bool &running, position &first, byte &ammount, direction &row_direction);
